...
contract SetWhitelistedProposer is HubGovernorTest {
  ...
  function testFuzz_EmitsWhitelistedProposerUpdated(address _proposer) public {
    ...
    function test_tm() public {
    vm.selectFork(vm.createFork("https://eth-sepolia.g.alchemy.com/v2/_A7lZ2J0FrbUnvsj0wE0ZDiyHBg8C148", 6444129));
	targets.push(0xfa9eBF6eC7A06aeb40fd32e7d7b2146b328C19e1);
	values.push(0);
	calldatas.push(hex"");
   
    HubGovernor(payable(0x69cBB9a59072663625a6E3EB3aeE31E435213F7b)).execute(targets, values, calldatas, 0xfe1dcb4dd964bcd101fe42bb21c14f57f8b56856763c6912596dcf6688a1031a);
  }
