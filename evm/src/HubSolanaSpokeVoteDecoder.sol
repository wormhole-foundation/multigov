...
/// @dev This contract handles decimal scaling when decoding votes from Solana. Since Solana's SPL tokens
/// typically use 6 decimals, this contract scales the vote amounts to match the hub chain's decimals.
