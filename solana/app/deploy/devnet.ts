...
export const DEPLOYER_AUTHORITY_KEYPAIR = loadKeypair(homedir() + DEPLOYER_AUTHORITY_PATH);

export const USER_AUTHORITY_PATH = "/.config/solana/user.json";
export const USER_AUTHORITY_KEYPAIR = loadKeypair(homedir() + USER_AUTHORITY_PATH);

export const USER2_AUTHORITY_PATH = "/.config/solana/user2.json";
export const USER2_AUTHORITY_KEYPAIR = loadKeypair(homedir() + USER2_AUTHORITY_PATH);
