// Usage: npx ts-node app/e2e/02_addProposal_mainnet.ts
...
//   console.log("bytes:", Buffer.from(request).toString("hex"))
  return (
    await axios.post(
...
async function addProposal() {
  try {
    ...
    if (proposalAccountData == null) {
      ...
      console.log("mainnetEthProposalResponse:",mainnetEthProposalResponse)
